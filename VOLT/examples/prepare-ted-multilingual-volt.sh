...
python3 ../volt.py --source_file $TRAIN_EN --target_file $TRAIN --token_candidate_file $BPE_INITIAL/code --vocab_file $prep/multilingual.vocab --max_number 100000 --interval 10000 --loop_in_ot 400 --tokenizer subword-nmt --size_file $prep/size.txt 
