...
python3 ../volt.py --source_file bpe30000/train.de  --token_candidate_file bpe30000/codede --vocab_file wmtde.vocab \
...
python3 ../volt.py --source_file bpe30000/train.en  --token_candidate_file bpe30000/codeen --vocab_file wmten.vocab \
